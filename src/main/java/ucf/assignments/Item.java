...
public class Item {
    /*
    Define private class variables for name(String), description (String), due date (Date), and complete (Boolean)
     */
    public Item(boolean complete, String description, Date dueDate, String name){
        /*
        Set complete to complete input parameter
        Set description to description input parameter
        Set due date to due date input parameter
        Set name to name input paramter
         */
    }
